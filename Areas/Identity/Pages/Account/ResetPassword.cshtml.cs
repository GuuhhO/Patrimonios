...
namespace Patrimonios.Areas.Identity.Pages.Account
{
    public class ResetPasswordModel : PageModel
    {
        ...
        public ResetPasswordModel(UserManager<PatrimoniosUser> userManager)
        {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "A {0} deve ter pelo menos {2} o no máximo {1} caracteres.", MinimumLength = 6)]
