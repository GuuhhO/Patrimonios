...
namespace Patrimonios.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            await _emailSender.SendEmailAsync("igustavo.oliveira@organize.net.br", "Teste do disparo de e-mails Patrimonios", "Enviado com sucesso. Obrigado.");
            return View();
        }
        ...
        public async Task<IActionResult> TesteEmail()
        {
            try
            {
                await _emailSender.SendEmailAsync("gustavo.oliveira@organize.net.br", "Teste do disparo de e-mails Patrimonios", "Enviado com sucesso. Obrigado.");
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        var subject = "Confirme seu e-mail - Organize Patrimônios";
                        var body = $@"
                        <p>Olá, {user.Name}</p>
                        <p>Recemos uma solicitação para criar uma conta com este endereço de e-mail no <strong>Organize Patrimônios</strong>.</p>
