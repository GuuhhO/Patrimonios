        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        _logger.LogInformation("O usuário criou uma conta usando o provedor {Nome}.", info.LoginProvider);
                        ...
                        await _emailSender.SendEmailAsync(Input.Email, "Confirme seu e-mail - Organize Patrimônios",
        ...
        private PatrimoniosUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Não é possível criar uma instância de '{nameof(PatrimoniosUser)}'. " +
                    ...
                    $"substituir a página de login externa em /Areas/Identity/Pages/Account/ExternalLogin.cshtml");
            }
        }
