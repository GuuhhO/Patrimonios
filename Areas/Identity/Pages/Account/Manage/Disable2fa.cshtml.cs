...
namespace Patrimonios.Areas.Identity.Pages.Account.Manage
{
    public class Disable2faModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            {
                throw new InvalidOperationException($"Não é possível desabilitar o 2FA para o usuário, pois ele não está habilitado no momento.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                throw new InvalidOperationException($"Ocorreu um erro inesperado ao desabilitar o 2FA.");
            }

            _logger.LogInformation("Usuário com ID '{UserId}' desabilitou 2fa.", _userManager.GetUserId(User));
            StatusMessage = "2fa foi desabilitado. Você pode habilitar 2fa ao configurar um aplicativo autenticador.";
